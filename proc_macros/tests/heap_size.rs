...
mod heap_size_tests {
    ...
    fn should_work() {
        ...
        assert_eq!(demo.a.heap_size_of_children(), 10);
        assert_eq!(demo.b.heap_size_of_children(), 0);
        assert_eq!(demo.c.heap_size_of_children(), 0);
        assert_eq!(demo.d.heap_size_of_children(), 6);
